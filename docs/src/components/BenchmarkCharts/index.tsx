...
const backends = [
  ...
  {key: 'yugabyte', label: 'YugabyteDB', color: 'var(--benchmark-yugabyte)'},
] as const;
...
const workloads: Record<string, Workload> = {
  'ccc-1': {
    ...
    throughput: {
      ...
      yugabyte: [103.066, 156.828, 189.896, 204.836, 204.834],
    },
    p99: {
      ...
      yugabyte: [32.511, 66.267, 137.99, 514.753, 1546.193],
    },
  },
  'ccc-100': {
    ...
    throughput: {
      ...
      yugabyte: [5729.954, 6723.228, 6829.839, 7019.828, 6566.281],
    },
    p99: {
      ...
      yugabyte: [35.289, 115.606, 404.582, 1214.953, 5327.896],
    },
  },
  'unconditional-1': {
    ...
    throughput: {
      ...
      yugabyte: [177.531, 336.394, 1172.56, 3571.041, 7159.026],
    },
    p99: {
      ...
      yugabyte: [11.702, 26.963, 29.416, 33.185, 79.901],
    },
  },
  'conditional-read': {
    ...
    throughput: {
      ...
      yugabyte: [2863.982, 9404.375, 22519.58, 28805.757, 29922.757],
    },
    p99: {
      ...
      yugabyte: [7.318, 8.93, 20.389, 63.934, 362.063],
    },
  },
  'projection-read': {
    ...
    throughput: {
      ...
      yugabyte: [45699.186, 121466.206, 208732.053, 236029.354, 241502.351],
    },
    p99: {
      ...
      yugabyte: [38.428, 65.441, 138.935, 630.741, 3905.843],
    },
  },
  mixed: {
    ...
    throughput: {
      ...
      yugabyte: [116.599, 232.564, 842.163, 2382.9, 5792.982],
    },
    p99: {
      ...
      yugabyte: [19.855, 33.078, 33.78, 65.032, 73.212],
    },
  },
};
    ...
    <section className={styles.chartCard}>
      ...
      <svg
        ...
        <desc id={`${id}-description`}>
          Comparison of PostgreSQL, SQLite, FoundationDB, and YugabyteDB at 1,
          4, 16, 64, and 256 clients.
        </desc>
